...
public class MapMainTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(map1.get("b01")); // null 없는 key 값을 요청하면 null 값이 반환된다
		...
		// map 원래 순서가 없지만 잠깐 응용을 하면 key값으로 for 문 정도는 활용할 수 있다.
		...
		for(String key : map1.keySet()) {
			System.out.println( "key" + key); // 반복돌면서 key 값 확인 
